...
public class LivreList extends SideMenuBaseForm {
    ...
    public LivreList() {
        ...
        f = new Form("Bibliotheque", BoxLayout.y());
        LivreService sp = new LivreService();
        ArrayList<Livre> p = sp.getLivres();
    ...
    public Container fillContainer(ArrayList<Livre> p) {
        ...
        if (p.size() > 0) {
            ...
            Label vide = new Label("aucun liste disponible ");
    ...
    public Button reservationBtn(Livre livre){
        ...
        btn3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                txt.setHint("veuilez saisir la Duree(en jours )");
                txt.setConstraint(TextField.NUMERIC);
                Button ok = new Button("    Ok    ");
                Validator v = new Validator();
                v.addConstraint(
                        txt, new NumericConstraint(true, 1, 15, "la duree doit etre ente 1 et 15 jours")
                );
