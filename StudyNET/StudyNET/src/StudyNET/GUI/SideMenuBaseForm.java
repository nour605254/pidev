    ...
    public void setupSideMenu(Resources res) {
        ...
        Button b = new Button("Envoyez Message");
           b.addActionListener(e->{
            String email = "sarra.ismaili@esprit.tn";
           ...
           Form ajj = new Form ("Formulaire des Matieres", BoxLayout.y());
        ...
        //med.addComponent(new SpanLabel("A task that uses a progress bar to show the user how far along it is"));
           med.add(en);
              med.show();
              Form ls= new Form("Vos Matiéres", BoxLayout.y());
              med.setTitle("Vos Evènements");
              Button lis = new Button("Liste des Matiéres ");
        ...
        getToolbar().addMaterialCommandToSideMenu("  Ajouter Matiére", FontImage.MATERIAL_TRENDING_UP,  e -> ajj.show());
        getToolbar().addMaterialCommandToSideMenu("  Afficher les Matiéres", FontImage.MATERIAL_SETTINGS,  e -> ls.show());
